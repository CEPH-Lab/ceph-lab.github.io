...
<style>
  ...
  .project-card {
    ...
    display: flex;
    flex-direction: column; /* Helps structure the inner content */
  }
  ...
  .project-summary {
    ...
    margin: 0 0 20px 0;
    font-size: 16px;
    flex: 1; /* Pushes the button cleanly to the bottom */
  }
  ...
  .read-more-btn {
    ...
    align-self: flex-start; /* Stops the button from stretching across the card */
  }
...
<div class="research-grid">
  ...
  <div class="project-card">
    <h3 class="project-title">Human Social Behavior</h3>
